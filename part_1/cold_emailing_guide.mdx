...
The first method of cold outreach involves sending out a large number of messages to engineers without doing extensive research. The primary goal is to generate a high volume of responses, which can be useful if you are looking for immediate job opportunities. This method is best for those who are seeking rapid results and less concerned with building long-term relationships.
...
Regardless of which approach you choose, it's essential to remember that the most valuable thing you can offer is your undivided attention and genuine curiosity.
...
- LinkedIn: Search for companies, job titles, and people with 1st-3rd degree connections. If you reach out with the right intentions, most people are more than willing to help out!
<Frame caption="Initial Outreach Example">
  <img src="/images/company/linkedin_message.png" />
</Frame>

Looking through college alumni networks and student organizations (FSAE, engineering societies) are a great starting point. If you're in school, try reaching out to peers or upperclassmen with career paths you want to emulate.

Once you’ve found contacts you want to reach out to, use the email hunting tools below to find relevant contact information:
